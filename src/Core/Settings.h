...
#define GC_POLARFLOW_TIMESTREAM_LOOPNUMBER   "<athlete-private>polarflow_timestream_loop_number"
#define GC_POLARFLOW_TIMESTREAM_RECORDINGRATE   "<athlete-private>polarflow_timestream_recording_rate"
